...
class AppCustomAuthenticator extends AbstractLoginFormAuthenticator
{
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, string $firewallName): ?Response
    {
        ...
        if ($user->getActivationToken() != NULL) {
            ...
            return new RedirectResponse($this->urlGenerator->generate('app_user_admin'));
        ...
        } elseif (in_array('4', $user->getRoles())) {
            if ($user->getStatuts() == "Actif" && $user->getActivationToken() == NULL) {
            ...
            if ($user->getActivationToken() != NULL) {
                ...
                return new RedirectResponse($this->urlGenerator->generate('app_desabled_user'));
            }
        }
        // For example:
        return new RedirectResponse($this->urlGenerator->generate('app_home'));
