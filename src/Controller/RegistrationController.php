...
class RegistrationController extends AbstractController
{
     ...
     */
    public function register(Request $request,\Swift_Mailer $mailer, UserPasswordHasherInterface $userPasswordHasher, EntityManagerInterface $entityManager , TexterInterface $texter ,FlashyNotifier $flashy
    ): Response
    {
        $user = new User();
...
$user->setIdRole($role);
            ...
            $flashy->info('Account created succssesfuly !', 'http://your-awesome-link.com');
